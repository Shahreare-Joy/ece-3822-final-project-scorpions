...
# Small fallback UI session history used only before the synthetic dataset loads.
MOCK_SESSIONS: list[GameSession] = [
    GameSession("S-89421", "scorpions-arena", "shahreare", "Win", 18420, 12, "Today 09:15", "Complete"),
    GameSession("S-89388", "sky-raiders", "shahreare", "Loss", 7400, 8, "Yesterday 21:42", "Complete"),
    GameSession("S-89310", "turbo-sprint", "shahreare", "Top 3", 12880, 6, "2 days ago", "Complete"),
