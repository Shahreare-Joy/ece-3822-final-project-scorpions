...
MOCK_CHAT: list[ChatMessage] = [
    ...
    ChatMessage("scorpions-arena", "Joy", "Launch handoff is ready in the arcade lobby.", "09:34", session_id="S-89421"),
    ChatMessage("scorpions-arena", "RenRunner", "Arena queue looks good. Need server broadcast next.", "09:36", session_id="S-89421"),
    ChatMessage("sky-raiders", "Joy", "Escape the City has a complete catalog page and is pending integration.", "21:44", session_id="S-89388"),
