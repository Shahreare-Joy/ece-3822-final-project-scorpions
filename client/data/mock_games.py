...
MOCK_GAMES: list[Game] = [
    ...
    game("scorpions-arena", "Fruit Collection", Genre.ARCADE.value, "Team Game 1. Shahreare's map-based fruit collection game launched from games/game_1/code/game/main.py while preserving its own graphics and relative paths.", "ECE 3822 Team Scorpions", 248, 98442, "Playable now", True, (210, 86, 98), ["team-game", "arcade", "fruit"], 2026, "Updated today", "Collect fruit around the map before the countdown ends.", True, "client/assets/thumbnails/fruit_drop_rush.png", "client/assets/screenshots/fruit_drop_rush.png"),
