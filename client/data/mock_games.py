...
MOCK_GAMES: list[Game] = [
    ...
    game("sky-raiders", "Escape the City", Genre.ACTION.value, "Team Game 2. A high-pressure city escape entry prepared for games/game_2/code/game/main.py. The detail page, stats, and launcher hook are ready while the folder integration is pending.", "Scorpions Team - Game 2", 1248, 613028, "Playable now", True, (78, 132, 224), ["team-game", "action", "escape"], 2023, "Updated 2 days ago", "Team game placeholder with launch wiring ready for folder testing.", True),
