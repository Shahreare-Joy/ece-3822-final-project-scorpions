...
MOCK_GAMES: list[Game] = [
    ...
    game("scorpions-arena", "Fruit Drop Rush", Genre.ARCADE.value, "Team Game 1. A fruit-catching rush game launched from games/game_1/code/game/main.py while preserving its own graphics and relative paths.", "ECE 3822 Team Scorpions", 248, 98442, "Playable now", True, (210, 86, 98), ["team-game", "arcade", "fruit"], 2026, "Updated today", "Team game folder is connected through the launcher.", True),
    # Team games 2-4: polished placeholders with full catalog/detail entries.
    # TODO(TEAM GAMES): When each teammate's folder is pasted and tested, set
    # playable=True and update the status text here.
    game("sky-raiders", "Escape the City", Genre.ACTION.value, "Team Game 2. A high-pressure city escape entry prepared for games/game_2/code/game/main.py. The detail page, stats, and launcher hook are ready while the folder integration is pending.", "Scorpions Team - Game 2", 1248, 613028, "Pending integration", False, (78, 132, 224), ["team-game", "action", "escape"], 2023, "Updated 2 days ago", "Team game placeholder with launch wiring ready for folder testing.", True),
    game("turbo-sprint", "Forgotten", Genre.ADVENTURE.value, "Team Game 3. A mystery-adventure entry prepared for games/game_3/code/game/main.py. The catalog page is complete, and the Play flow will enable once the teammate folder is connected.", "Scorpions Team - Game 3", 741, 421776, "Pending integration", False, (224, 116, 72), ["team-game", "adventure", "mystery"], 2022, "Updated last week", "Team game placeholder with detail, history, and leaderboard previews ready.", True),
    game("crystal-run", "Mystical Bamboo", Genre.PLATFORMER.value, "Team Game 4. A polished bamboo-themed platformer entry prepared for games/game_4/code/game/main.py. It appears fully in the arcade while launch integration is still pending.", "Scorpions Team - Game 4", 398, 289410, "Pending integration", False, (210, 170, 76), ["team-game", "platformer", "bamboo"], 2024, "Updated 4 days ago", "Team game placeholder ready for teammate folder connection.", True),
    ...
    game("snake-test", "Snake Test Lab", Genre.ARCADE.value, "Temporary Snake game kept outside the final platform catalog logic. It is only a local test harness and should be deleted before final submission if the team no longer needs it.", "Local Test Harness", 12, 318, "Temporary test", False, (92, 190, 116), ["temporary", "test-game", "safe-to-delete"], 2026, "Temporary build", "TEMP TEST GAME - safe to delete after the real team games are connected.", False),
    ...
    game("tiny-tactics", "Tiny Tactics", Genre.STRATEGY.value, "Small-board strategy with fast matches and seasonal ladders.", "Scorpions Catalog", 557, 188204, "Live", False, (178, 132, 78), ["strategy", "short-session"], 2025, "Updated 2 weeks ago", "Season 4 ladder preview is mocked."),
    ...
    game("chessbyte-royale", "Chessbyte Royale", Genre.STRATEGY.value, "A fast strategy remix where pieces upgrade through arcade-style capture chains.", "Scorpions Catalog", 689, 267830, "Live", False, (150, 136, 94), ["strategy", "board"], 2024, "Updated last week", "Opening book stats are mocked."),
    ...
    game("mystic-mailroom", "Mystic Mailroom", Genre.COOP.value, "Two-player delivery routes through shifting rooms and timed portal doors.", "Scorpions Catalog", 344, 140982, "Live", False, (176, 104, 188), ["co-op", "timed"], 2025, "Updated 2 weeks ago", "Co-op route matching is mocked."),
