...
- Add optional noisy-data generation if required.
- Implement cleaning rules for duplicate/bad/missing values.
- Load cleaned records into custom data structures.
- Benchmark custom structures against brute-force baselines.
- Document all cleaning decisions in the final report.
