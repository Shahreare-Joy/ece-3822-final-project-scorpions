...
ENEMY_SPAWN_DATA = [
    {
        "name": "broken_runner",
        "spawn": (5, 16),
        "waypoints": [(5, 12), (5, 18), (8, 18), (8, 12)],
        "patrol_type": "circular",
        "speed": 1,
        "description": "Patrols the top-left forest area",
    ...
    },
    {
        ...
        "speed": 0.9,
        "description": "Patrols the top-right area",
    ...
    },
    {
        "name": "broken_trader",
        "spawn": (18, 37),
        "waypoints": [(17, 35), (19, 35), (19, 39), (17, 39)],
        "patrol_type": "circular",
        "speed": 0.8,
        "description": "Circles the mid-center area",
        "health": 40, "exp": 20, "attack_damage": 5,
        "notice_radius": 150, "attack_radius": 50,
    },
    {
        "name": "navigate",
        "spawn": (32, 6),
        "waypoints": [(32, 3), (32, 10)],
        "patrol_type": "back_and_forth",
        "speed": 1,
        "description": "Patrols the bottom-left corridor",
    ...
    },
    {
        "name": "chase",
        "spawn": (32, 48),
        "waypoints": [(30, 48), (34, 48)],
        "patrol_type": "back_and_forth",
        "speed": 0.8,
        "description": "Guards the bottom-right area",
        "health": 40, "exp": 20, "attack_damage": 5,
        "notice_radius": 150, "attack_radius": 50,
    },
]
