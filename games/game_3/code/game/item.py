...
def create_example_items():
  ...
  # Quest Item
    items.append(QuestItem(
        name="Cure",
        description="The cure to virus that needs to be delivered to remaining humans in space",
        image_path="../../graphics/items/cure.png",
        quest_id="quest_cure"
    ))
    ...
    items.append(Consumable(
        name="Clean Oil",
        description="Nothing like a fresh oil change to keep things running smoothly",
        image_path="../../graphics/items/clean_oil.png",
        effect_type="speed",
        effect_amount=10,
        value=30
    ))
    ...
    items.append(Consumable(
        name="Small Battery",
        description="A small battery found everywhere used to keep yourself going for a little longer",
        image_path="../../graphics/items/small_battery.png",
        effect_type="heal",
        effect_amount=50,
        value=75
    ))
    ...
    items.append(Consumable(
        name="Large Battery",
        description="A larger battery used for larger machines and can charge smaller machines for a long time",
        image_path="../../graphics/items/large_battery.png",
        effect_type="heal",
        effect_amount=150,
        value=200
    ))
    ...
    items.append(Armor(
        ...
        description="Great armor that doesn't hold you down while protecting you",
        image_path="../../graphics/items/titanium_plating.png",
        defense_bonus=10,
        value=300
    ))
    ...
    items.append(Weapon(
        name="Hydraulic Arm",
        description="A part found on some Demolisher machines used to carry heavy objects but also good at dealing heavy damage",
        image_path="../../graphics/items/hydraulic_arm.png",
        attack_bonus=10,
        value=250
    ))

    items.append(Weapon(
        name="Multi-Joint Arm",
        description="Being able to move faster by getting rid of some parts is a good way to get around",
        image_path="../../graphics/items/multi_joint_arm.png",
        attack_bonus=10,
        value=350
    ))
    ...
    items.append(Weapon(
        name="Stun Launcher",
        description="A grenade launcher filled with metal scrap, used to push enemies",
        image_path="../../graphics/items/stun_launcher.png",
        attack_bonus=5,
        value=175
    ))
