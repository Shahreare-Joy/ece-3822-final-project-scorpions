"""
waypoint.py - Waypoint node for enemy patrol paths

Copy your completed implementation from Lab 5 into this file.
"""

# TODID: Copy your Waypoint implementation from Lab 5 here
...
class Waypoint:
    ...
    def __init__(self, x, y, wait_time=0):
        ...
        """
        # TODID: Store x, y, wait_time
        # TODID: Initialize next pointer to None
        # TODID: Initialize prev pointer to None (needed for doubly linked lists)
    ...
    def distance_to(self, other_x, other_y):
        ...
        """
        # TODID: Calculate and return sqrt((x2-x1)^2 + (y2-y1)^2)
