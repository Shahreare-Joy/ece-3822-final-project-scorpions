...
"""Game 1: simple Snake example.

This is the one working starter game. It is intentionally small and local.

TODO(GAME 1): Replace or expand this into the team's real playable game. Future
multiplayer state should come from cpp_server/ through the launch service.
"""
...
def run_game(player: object = None) -> dict[str, object]:
    ...
    pygame.display.set_caption("Scorpions Arcade - Game 1 Snake")
    ...
    return {"ok": True, "score": score, "message": f"Game 1 Snake ended with {score} points."}
...
def _draw(screen: pygame.Surface, area: pygame.Rect, cell: int, snake: deque[tuple[int, int]], food: tuple[int, int], score: int, game_over: bool, font: pygame.font.Font) -> None:
    ...
    screen.blit(font.render(f"Game 1 Snake | Score: {score} | ESC/Q exits", True, (240, 244, 252)), (area.x, 38))
