...
def create_example_items():
    ...
    Students should create their own items based on Lab 1 designs.
    """
    items = []
    ...
    items.append(Weapon(
        name="Short Sword",
        description="A balanced beginner blade.",
        image_path="../graphics/items/shortsword.png",
        attack_bonus=14,
        value=130
    ))
    ...
    items.append(Weapon(
        name="Steel Sword",
        description="A reliable steel blade. Balanced and deadly.",
    ...
    items.append(Weapon(
        name="Polearm",
        description="Long reach and strong impact.",
        image_path="../graphics/items/polearm.png",
        attack_bonus=13,
        value=120
    ))
    ...
    items.append(Weapon(
        name="Magic Staff",
        description="Channel magical power.",
    ...
    items.append(Armor(
        ...
        description="Strong upper body protection.",
        image_path="../graphics/items/chestplate.png",
        defense_bonus=15,
        value=280
    ))
    ...
    items.append(Armor(
        name="Cloak",
        description="Light defensive garment.",
        image_path="../graphics/items/cloak.png",
        defense_bonus=6,
        value=120
    ))
    ...
    items.append(Armor(
        name="Jade Bracer",
        description="Mystical arm guard.",
        image_path="../graphics/items/jadebracer.png",
        defense_bonus=8,
        value=160
    ))
    ...
    items.append(Consumable(
        ...
        image_path="../graphics/items/hppotion.png",
        effect_type="heal",
        effect_amount=50,
        value=25,
        max_stack=99
